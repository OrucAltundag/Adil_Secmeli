...
class DecisionPolicy(Base):
    ...
    classification_method = Column(String, nullable=False, default="electre_tri_b")
    electre_lambda = Column(Float, nullable=False, default=0.65)
    electre_assignment_rule = Column(String, nullable=False, default="pessimistic")
    electre_q_json = Column(Text)
    electre_p_json = Column(Text)
    electre_veto_json = Column(Text)
    electre_profiles_json = Column(Text)
    is_active = Column(Boolean, nullable=False, default=True)
    created_at = Column(DateTime)
    updated_at = Column(DateTime)
    notes = Column(Text)
...
class CourseDecision(Base):
    ...
    electre_category = Column(String)
    electre_credibility = Column(Float)
    electre_details_json = Column(Text)
    dt_prediction_status = Column(Integer)
    dt_confidence = Column(Float)
    dt_comparison = Column(String)
    dt_rule_path = Column(Text)
    dt_details_json = Column(Text)
    created_at = Column(DateTime)
