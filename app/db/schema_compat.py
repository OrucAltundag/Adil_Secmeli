    ...
    table_ddls = {
        ...
        "decision_policies": """
            CREATE TABLE decision_policies (
                ...
                classification_method TEXT NOT NULL DEFAULT 'electre_tri_b',
                electre_lambda REAL NOT NULL DEFAULT 0.65,
                electre_assignment_rule TEXT NOT NULL DEFAULT 'pessimistic',
                electre_q_json TEXT,
                electre_p_json TEXT,
                electre_veto_json TEXT,
                electre_profiles_json TEXT,
                is_active INTEGER NOT NULL DEFAULT 1,
                created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
                updated_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
                notes TEXT,
        ...
        "course_decisions": """
            CREATE TABLE course_decisions (
                ...
                electre_category TEXT,
                electre_credibility REAL,
                electre_details_json TEXT,
                dt_prediction_status INTEGER,
                dt_confidence REAL,
                dt_comparison TEXT,
                dt_rule_path TEXT,
                dt_details_json TEXT,
                created_at TEXT NOT NULL DEFAULT CURRENT_TIMESTAMP,
                CHECK (
