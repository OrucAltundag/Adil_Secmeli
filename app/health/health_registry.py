...
ALGORITHM_CATALOG: list[dict[str, str]] = [
    ...
    {"name": "Decision Tree", "status": "ACTIVE", "purpose": "ELECTRE TRI-B kararına geçmiş final kararlardan bağımsız ikinci görüş üretir.", "used_in": "Karar Merkezi / Ders Kararları", "state": "Geçmiş örnek yeterliyse çalışıyor; nihai kararı değiştirmez"},
    ...
    {"name": "Linear Regression", "status": "ACTIVE", "purpose": "Son üç kesinleşme puanından sonraki yıl trend skorunu tahmin eder.", "used_in": "Veri / Trend ve DT özelliği", "state": "Çalışıyor; eksik yılda nötr 50 kullanır"},
    {"name": "ELECTRE TRI-B", "status": "ACTIVE", "purpose": "Ham kriterleri sınır profilleri, uyum, veto ve lambda ile akademik statüye atar.", "used_in": "Karar Merkezi / Karar Politikaları", "state": "Çalışıyor"},
    {"name": "PROMETHEE II", "status": "ACTIVE", "purpose": "Müfredat dışı adayları net akışla sıralayıp çeşitlilik kontrollü Top-7 üretir.", "used_in": "Karar Merkezi / Önerilen Dersler", "state": "Çalışıyor"},
